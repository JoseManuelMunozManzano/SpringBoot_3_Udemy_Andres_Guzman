...
public class Person {
  ...
  // Incorporamos los campos reutilizables, y preparados para ser incorporados, de la clase Audit.
  // Tenemos que crear la instancia.
  @Embedded
  ...
  // Uso de audit, a través de sus métodos getter
  @Override
