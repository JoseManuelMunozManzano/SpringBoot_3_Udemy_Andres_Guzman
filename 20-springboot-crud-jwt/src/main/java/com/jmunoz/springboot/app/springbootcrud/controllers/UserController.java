...
// Para evitar error de CORS se indica @CrossOrigin.
// Si no se indica nada, permite todas las cabeceras que vienen desde el frontend.
// Usando origins somos muy específicos.
// Si queremos ser más generales usaremos originPatterns
...
public class UserController {
  ...
  //
  // Se incluyen aquí anotaciones para controlar las autorizaciones a estos endpoints que no son públicos.
