...
public class Client {
  ...
  //
  // Como hemos indicado @JoinColumn, NO se crea tabla intermedia, sino que en la
  // tabla addresses, que es la 
  // dueña de la relación, se creará el campo de foreign key client_id.
  //
